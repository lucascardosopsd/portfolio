...
const WppFloatingButton = () => {
  ...
  return (
    <div className="fixed z-20 bottom-4 right-4 block tablet:hidden bg-zinc-950">
      <Link href="https://api.whatsapp.com/send?phone=5517996484654">
        <div className="flex items-center justify-center border border-green-500 bg-background text-green-500 rounded h-32 w-16 flex-col gap-2 z-10 relative animate-pulse">
