      ...
      >
        ...
        <div className="flex-1 tablet:w:2/3 mt-10 tablet:mt-0 space-y-4">
          <div className="flex flex-col gap-3 items-center tablet:items-start max-w-2xl text-center tablet:text-left">
            <p className="px-4 py-2 bg-zinc-800 text-zinc-100 w-max rounded">
              {data.greeting[lang]}
            </p>
            <h1 className="text-zinc-100">{data.title[lang]}</h1>
            <p className="text-zinc-300">{data.subtitle[lang]}</p>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <Link
              href="/contact"
              className="btn border hover:bg-zinc-100 hover:text-purple transition border-zinc-600 text-zinc-100"
            >
              <Phone />
        ...
        <div className="flex flex-1 h-full w-full items-center justify-center py-4 tablet:py-0">
          <div className="relative h-[70vh] w-auto rounded-2xl border dark border-zinc-800 bg-gradient-to-t from-zinc-800 to-zinc-900">
            <Image
